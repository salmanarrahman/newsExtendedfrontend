...
<html lang="en">
  ...
  <?php
  $user = new User();
  if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['addDate'])){
      $category = $user->addDate($_POST);
...
<table class="table table-striped">
 ...
 try {
     ...
     while ($row = $query->fetch()) {
         ...
         echo "<a href='deleteDate.php?id=". $row['dateid'] ."'> <img src=\"resources/trashcan.png\" width=\"30\" height=\"30\" ></a>"   ;
    ...
    <div class="modal-content">
      ...
      <!-- Modal body -->
        <form action="" method="post">
          ...
          <button   type="submit" class="btn btn-dark" name="addDate"> Add New Publication</button>
